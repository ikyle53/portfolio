  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/ikyle53" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%'}}>
          <div className="col-md-12">
            <div>
              <span className="iconify header-icon" data-icon="et:mobile" data-inline="false"></span>
              <br/>
              <h1 className="mb-0">
                {name}
              </h1>
              ...
              <h3 style={{width: '50%', margin: 'auto'}} className="headline">
                {headline}
              </h3>
